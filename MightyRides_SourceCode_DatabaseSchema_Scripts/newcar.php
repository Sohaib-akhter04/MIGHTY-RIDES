...
$query1 = "select Name,Dname,Mname,status,manufacturer.phoneno as mph,manufacturer.location as mloc,manufacturer.email as memail,manufacturer.website as mweb,dealer.phoneno as dph,d_email,dealer.website as dweb,mileage,color,status, customerid,
...
// removed customer id from query1
...
<html>
<head>
    <title><?php echo $firstquery["Name"]?> - MightyRides</title>
...
<div class="tab-content" id="nav-tabContent">
  ...
  <div class="card-body">
    ...
    <?php if($firstquery["discount"]!==null || $firstquery["discount"] > 0 ){ 
