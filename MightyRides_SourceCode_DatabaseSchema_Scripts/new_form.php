...
//prepared statement
$prepstat = "insert into car(name,cartype,mileage,color,status,fueltype,manufacturedate,manufacturerid,dealerid) values (?,'new',?,?,'available',?,?,?, $dealerid)";
...
mysqli_stmt_bind_param($stmt, "ssssss", $name,  $mileage, $color, $fueltype, $m_date, $m_id);
    ...
    if(mysqli_stmt_execute($stmt))
    {
        ...
        $ownsquery = "insert into owns (carid, dealerid) values ($car_id,$dealerid)";
    ...
    <div class="testbox">
      ...
      <div id="back" style="border-radius:5px;padding:10px;background-color:#D7BDE2;color:#512E5F;margin-bottom:10px;cursor:pointer;width:fit-content;font-size:18px" onclick="back()">< Go back</div>
        ...
        <div class="item">
          ...
          <div class="item">
            <input type="text" name="name" placeholder="Car Name (along with manufacturer name | eg - Suzuki Mehran)" required>
          </div>
