...
//prepared statement
$prepstat = "insert into car(name,cartype,mileage,color,status,fueltype,manufacturedate,licenseplateno,manufacturerid, dealerid) values (?,'resale',?,?,'available',?,?,?,?, $dealerid)";
...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Add Resale Car - MightyRides&copy;</title>
