...
<html>
<head>
  <title><?php echo $dealername."'s " ?> Profile - MightyRides</title>
  <meta charset="utf-8">
...
<div class="container bootstrap snippet" style="width:80%;margin:auto;margin-top:135px;margin-bottom:60px">
    <div class="row" style="padding:20px 0;border-bottom:1px solid #C39BD3">
    	...
    	<!--<div class="col-sm-2"><img title="profile image" height="60px" class="img-circle img-responsive" src="logo.jpg" alt = "MightyRides Logo" ></div>-->
    </div>
    <div class="row">
