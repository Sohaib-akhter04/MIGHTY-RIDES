...
<html>
<head>
    <title><?php echo $dealername."'s " ?> rented cars - MightyRides</title>
...
$rentedcarsquery1 = "select     rentalcarid,
                                rent.customerid,
                                customername,
                                name,
                                DATE_FORMAT(rentdate,'%d %M %Y') as rentdate,
                    ...
                    from rent
                        ...
                        inner join customer
                        inner join car
                    where       rentalcarid=car.carid
                        and     rent.customerid=customer.customerid
                        and     rentalcarid=owns.carid 
                        and     enddate is null 
