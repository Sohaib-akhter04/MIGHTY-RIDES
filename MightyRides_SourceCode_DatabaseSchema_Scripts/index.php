...
<body>
    <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
        <div class="container" id="header"><a class="navbar-brand" href="#" style="color: rgba(114,22,77,0.9)">MightyRides&copy; <span style="color:black">Car Dealership</span></a>
                <div class="collapse navbar-collapse" id="navcol-1"><a class="ml-auto" id="loginbut" href="login.php">Login</a></div>
        </div>
    </nav>
    <header class="masthead text-white text-center" style="background: url('assets/img/bg.jpg')no-repeat center center;background-size: cover;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h1 class="text-capitalize text-center text-white mb-5">Welcome to MightyRides</h1>
                </div>
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <h2 style="color: rgba(0,0,0,1);">MightyRides - the first buy limo-MARKET.</h2>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <h4 style="color: rgba(0, 0, 0, 0.49);">MightyRides brings you all range of premium cars at your service.</h4>
                </div>
            </div>
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text">
                    ...
                    <h4 style="color: rgba(0, 0, 0, 0.49);">All dealerships care about their customers but MightyRides takes it to a whole new level.</h4>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/e1m.jpg">
                        <h5>Elon Musk</h5>
                        <h5>CEO- TWITTER | TESLA, INC.</h5>
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"I bought twitter just to fire Employees"</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/messi.jpg">
                        <h5>Lionel Messi</h5>
                        <h5>Professional Footballer</h5>
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"I am not &#128016;. I am Lionel Messi"</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/sm2.jpg">
                        <h5>Sunij Manj</h5>
                        <h6>CEO and Founder - Pakwheels</h6>
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"MightyRides have the perfect make, model and variant. It is even better than our pakwheels"</p>
                    </div>
                </div>
                ...
                <!-- <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/hb.jpg">
                        ...
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"If anyone ask me about the MightyRidesCars, I'd just say One Word - ELEGANT."</p>
                    </div>
                </div> -->
                <!-- <div class="col-lg-4">
                    <div class="mx-auto testimonial-item mb-5 mb-lg-0"><img class="rounded-circle img-fluid mb-3" src="assets/img/s6d.jpg">
                        ...
                        <p class="font-weight-light mb-0" style="color: rgba(114,22,77,0.9);">"Whenever I visit MightyRides, I feel like Lamborghini is just a portion of it."</p>
                    </div>
                </div> -->
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 my-auto h-100 text-center text-lg-left">
                    <ul class="list-inline mb-2">
                        <li class="list-inline-item"><a href="./About.html" style="color: rgb(248,249,250);">About</a></li>
                        <li class="list-inline-item"><a href="./contact.html" style="color: rgb(248,249,250);">Contact</a></li>
                        <li class="list-inline-item"><a href="#" style="color: rgb(248,249,250);">Terms of Use &amp Privacy Policy</a></li>
                        <li class="list-inline-item"></li>
                    </ul>
                    <p class="text-left text-muted small mb-4 mb-lg-0" style="color: rgb(248,249,250);">© MightyRides. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer>
