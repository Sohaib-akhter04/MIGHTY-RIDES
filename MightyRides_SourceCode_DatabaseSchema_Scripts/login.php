...
if(isset($_POST["submit"]))
{
    ...
    if(mysqli_num_rows($customer_result)) // == 1)
    {
        ...
        // else
        // {
        //     echo "<script> alert(\"Your account has not been verified yet! A verification email has already been sent to $email. Please acknowledge it in order to activate your account!")</script>";
        // }
    }
    else
    {
        ...
        echo mysqli_num_rows($dealer_result);
...
<div class="main-header"> Login to MigtyRides </div>
...
<div class="main" style="text-align: center;">
    New to MigtyRides? <a href="register.html">Register here</a>
</div>
</div>
</body>
</html>